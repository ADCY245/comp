...
async function handleRequestOtp(e) {
  ...
  try {
    ...
    if (response.ok && result && result.success === true) {
      ...
      const responseEmail = result.email || email;
      currentEmail = responseEmail;
      ...
      const emailDisplay = document.getElementById('emailDisplay');
      if (emailDisplay) {
        emailDisplay.textContent = responseEmail;
      }
      ...
      showSuccess('Verification code sent to ' + responseEmail);
